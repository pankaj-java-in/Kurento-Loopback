...
//const ws = new WebSocket('wss://65.1.225.216:8443/helloword');
...
function uiStart()
{
  ...
  webRtcPeer = new kurentoUtils.WebRtcPeer.WebRtcPeerSendrecv(options, function(err)
  {
    if (err) {
